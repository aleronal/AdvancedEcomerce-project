                ...
                <div class="row">
                    <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                <textarea class="form-control" name="meta_description" id="textarea" cols="30" rows="10">{{$seo->meta_description}}</textarea></div>
                            </div>
                            <div class="form-group">
                                    <h5>Google Analytics<span class="text-danger">*</span></h5>
                                    <div class="controls">
                                    <textarea class="form-control" name="google_analytics" id="textarea" cols="30" rows="10">{{$seo->google_analytics}}</textarea></div>
                                </div>
