        ...
        <div class="container">
          <div class="row"> 
            ...
            <div class="col-xs-12 col-sm-12 col-md-3 sidebar"> 
              ...
              @include('frontend.common.tags_product')
                ...
                <div class="row">
                  <div class="col-md-7 col-sm-7">
                    <div class="wide-banner cnt-strip">
                      <div class="image"> <img class="img-responsive" src="{{asset('frontend/assets/images/banners/home-banner1.jpg')}}
                      </div>" alt=""> </div>
                    <!-- /.wide-banner --> 
                  </div>
                  <!-- /.col -->
          ...
          <div class="item item-carousel">
            <div class="products">
              ...
              {{-- Skip Products 0 ======================== --}}
              <section class="section featured-product wow fadeInUp">
                  <h3 class="section-title">{{$skipCategory_0->category_name_en}}</h3>
                  <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
  
                    @foreach ($skipProduct_0 as $product)
                ...
                <section class="section featured-product wow fadeInUp">
                  <h3 class="section-title">{{$skipCategory_1->category_name_en}}</h3>
                  <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
  
                    @foreach ($skipProduct_1 as $product)
                  ...
                  <div class="owl-carousel blog-slider custom-carousel">
                    ...
                    <div class="item">
                      <div class="blog-post">
                        ...
                        <div class="image"> <a href="{{route('details-blog',$post->id)}}"><img src="{{asset($post->post_image)}}" alt=""></a> </div>
                        </div>
                        <!-- /.blog-post-image -->
                        ...
                        <div class="blog-post-info text-left">
                          ...
                          <p class="text">
                            @if (session()->get('language') =='spanish')
                                {!! Str::limit($post->post_details_es, 100) !!}
                            @else
                                {!! Str::limit($post->post_details_en, 100) !!}
                            @endif
                          </p>
                        <a href="{{ route('details-blog',$post->id) }}" class="lnk btn btn-primary">Read more</a> </div>
                        <!-- /.blog-post-info --> 
